...
### ML & CyberSec
- **[subwiz](https://github.com/hadriansecurity/subwiz)** - nanoGPT based model, trained to discover subdomains.
...
- **[colibri](https://github.com/JustVugg/colibri)** - Run GLM-5.2 (744B-parameter MoE) on a consumer machine with ~25 GB of RAM — in pure C, with zero dependencies, by streaming experts from disk.
